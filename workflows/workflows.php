...
/**
 * Class Disciple_Tools_PII_Obfuscator_Workflows
 *
 * @since  1.11.0
 */
class Disciple_Tools_PII_Obfuscator_Workflows {
    ...
    /**
     * Disciple_Tools_PII_Obfuscator_Workflows The single instance of Disciple_Tools_PII_Obfuscator_Workflows.
     *
     * @var    object
     * @access private
     * @since  1.11.0
    ...
    /**
     * Main Disciple_Tools_PII_Obfuscator_Workflows Instance
     *
     * Ensures only one instance of Disciple_Tools_PII_Obfuscator_Workflows is loaded or can be loaded.
     *
     * @return Disciple_Tools_PII_Obfuscator_Workflows instance
     * @since  1.11.0
     */
    ...
    /**
     * Disciple_Tools_PII_Obfuscator_Workflows constructor.
     */
    ...
    private function build_default_workflows_starter( &$workflows ) {
        $dt_fields = DT_Posts::get_post_field_settings( 'pii_obfuscator' );
        ...
        $workflows[] = (object) [
            ...
            'actions'    => [
                Disciple_Tools_Workflows_Defaults::new_action( Disciple_Tools_Workflows_Defaults::$action_update,
                    [
                        'id'    => 'disciple_tools_pii_obfuscator_text',
                        'label' => $dt_fields['disciple_tools_pii_obfuscator_text']['name']
                    ], [
...
Disciple_Tools_PII_Obfuscator_Workflows::instance();
