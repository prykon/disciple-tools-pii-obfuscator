...
class Disciple_Tools_PII_Obfuscator_Site_Links {
    public $type = 'disciple_tools_pii_obfuscator';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'PII Obfuscator' );
        return $type;
    }
}
Disciple_Tools_PII_Obfuscator_Site_Links::instance();
